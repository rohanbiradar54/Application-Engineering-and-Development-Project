...
public class HospitalManageEmployeeJPanel extends javax.swing.JPanel {
     ...
     */
    public HospitalManageEmployeeJPanel(JPanel userProcessContainer,UserAcc account,Enterprise enterprise) {
        initComponents();
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
       ...
       try{ 
        ...
        if(organization.getUserAccountDirectory().checkIfUsernameIsUnique(userName)){
            Counselor employee = organization.getEmployeeDirectory().createandaddCounselor(name);
